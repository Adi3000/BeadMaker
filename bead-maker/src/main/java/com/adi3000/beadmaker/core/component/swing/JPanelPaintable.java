 ...
 */
public class JPanelPaintable extends JPanel
{
	 ...
	 */
	public JPanelPaintable(Image image)
	{
		this(image, SCALED);
	}
	 ...
	 */
	public JPanelPaintable(Image image, int style)
	{
		setImage( image );
		setStyle( style );
	 ...
	 */
	public JPanelPaintable(Image image, int style, float alignmentX, float alignmentY)
	{
		setImage( image );
		setStyle( style );
	 ...
	 */
	public JPanelPaintable(Paint painter)
	{
		this(painter, true);
	}
	
	
	public JPanelPaintable(Paint painter, boolean setLayout)
	{
		setPaint( painter );
		if (setLayout) {
			setLayout( new BorderLayout() );
